...
INSERT INTO orders (customer_id, order_date, order_number, order_amount) VALUES
  ...
  SELECT * FROM orders;
-- Select Statement 
SELECT customer_id, first_name,email, created_date, active FROM customer;

-- Update Statement
UPDATE customer
SET first_name='Khushi',
last_name='Wala', 
email='khushi122004@example.com'
WHERE customer_id = 1; 
 SELECT * FROM customer;
-- Delete Statement 
...
--filtering data
SELECT last_name,first_name,email FROM customer WHERE first_name = 'Khushi';
SELECT customer_id, first_name,last_name FROM customer
WHERE
	first_name = 'Hiren' OR last_name = 'Wala';
...
IN (select customer_id from customer where active = true)
